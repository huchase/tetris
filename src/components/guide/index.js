      ...
      <div style={{ display: this.state.isMobile ? 'none' : 'block' }}>
        ...
        <div className={`${style.guide} ${style.left}`}>
          <p>
            ...
            <iframe
              src="https://ghbtns.com/github-btn.html?user=huchase&repo=tetris&type=star&count=true"
              frameBorder="0"
              scrolling="0"
              width="170px"
              height="20px"
            ...
            <br />
            <iframe
              src="https://ghbtns.com/github-btn.html?user=huchase&repo=tetris&type=fork&count=true"
              frameBorder="0"
              scrolling="0"
              width="170px"
              height="20px"
